...
The actual tasks you need to complete are in [`guides/TASKS.md`](guides/TASKS.md).
...
8. Go to [`guides/TASKS.md`](guides/TASKS.md) and create a GitHub Issue for each task.
